...
public class UIAxes extends UI3dComponent {
	...
	public UIAxes() {
		super();
		this.addChild(new UIBillboardText("X", LPMeshable.xAxis, 1, LXColor.RED, alpha));
		this.addChild(new UIBillboardText("Y", LPMeshable.yAxis, 1, LXColor.GREEN, alpha));
		this.addChild(new UIBillboardText("Z", LPMeshable.zAxis, 1, LXColor.BLUE, alpha));
	}
    @Override
