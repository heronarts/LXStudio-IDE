...
public class PBCRC {
	...
	public static long[] table = new long[]{ 0x00000000L, 0x77073096L, 0xee0e612cL,
		...
		0x79dcb8a4L, 0xe0d5e91eL, 0x97d2d988L, 0x09b64c2bL, 0x7eb17cbdL, 0xe7b82d07L,
		...
		0xb6662d3dL, 0x76dc4190L, 0x01db7106L, 0x98d220bcL, 0xefd5102aL, 0x71b18589L,
		0x06b6b51fL, 0x9fbfe4a5L, 0xe8b8d433L, 0x7807c9a2L, 0x0f00f934L, 0x9609a88eL,
		...
		0x9309ff9dL, 0x0a00ae27L, 0x7d079eb1L, 0xf00f9344L, 0x8708a3d2L, 0x1e01f268L,
		...
		0x026d930aL, 0x9c0906a9L, 0xeb0e363fL, 0x72076785L, 0x05005713L, 0x95bf4a82L,
		0xe2b87a14L, 0x7bb12baeL, 0x0cb61b38L, 0x92d28e9bL, 0xe5d5be0dL, 0x7cdcefb7L,
		0x0bdbdf21L, 0x86d3d2d4L, 0xf1d4e242L, 0x68ddb3f8L, 0x1fda836eL, 0x81be16cdL,
	...
	public void updateByte(byte b) {
		int tbl_idx = ByteUtils.asUint8(ByteUtils.asUint32(crc) ^ ByteUtils.asUint32(b));
		long newcrc = ByteUtils.asUint32(table[tbl_idx]) ^ ByteUtils.asUint32(crc >> 8);
		logger.fine(String.format(
			...
			,
			b,
			ByteUtils.asUint32(b),
			crc,
			ByteUtils.asUint32(crc),
			ByteUtils.asUint32(crc) ^ ByteUtils.asUint32(b),
			tbl_idx,
			table[tbl_idx],
			ByteUtils.asUint32(table[tbl_idx]),
			crc >> 8,
