...
public class PBMessageFactoryAPA102Data extends PBMessageFactoryData{
	...
	public PBMessageFactoryAPA102Data(final PBColorOrder colorOrder, int channel, int[] indexBuffer, long freq) {
		super(PBRecordType.SET_CHANNEL_APA102_DATA, channel, indexBuffer, 8, colorOrder);
		this.freq = freq;
	}
	@Override
